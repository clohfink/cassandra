    ...
    final static class Chunk implements DirectBuffer
    {
        ...
        static Chunk getParentChunk(ByteBuffer buffer)
        {
            ...
            if (attachment instanceof Ref.DirectBufferRef)
                return ((Ref.DirectBufferRef<Chunk>) attachment).get();
        ...
        void setAttachment(ByteBuffer buffer)
        {
            if (Ref.DEBUG_ENABLED)
                MemoryUtil.setAttachment(buffer, new Ref.DirectBufferRef<>(this, null));
            else
        ...
        boolean releaseAttachment(ByteBuffer buffer)
        {
            ...
            if (Ref.DEBUG_ENABLED)
                ((Ref.DirectBufferRef<Chunk>) attachment).release();
