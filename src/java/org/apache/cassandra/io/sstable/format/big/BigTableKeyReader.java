...
public class BigTableKeyReader implements KeyReader
{
    ...
    private BigTableKeyReader(FileHandle indexFile,
                              ...
                              RowIndexEntry.IndexSerializer rowIndexEntrySerializer)
    {
    ...
    public static BigTableKeyReader create(FileHandle indexFile, RandomAccessReader indexFileReader, RowIndexEntry.IndexSerializer serializer) throws IOException
    {
    ...
    public static BigTableKeyReader create(FileHandle indexFile,  RowIndexEntry.IndexSerializer serializer) throws IOException
    {
        ...
        catch (IOException | RuntimeException ex)
        {
            ...
            {
                closeResourceSafely(ex, reader);
                closeResourceSafely(ex, iFile);
            }
            throw ex;
        }
    }

    private static void closeResourceSafely(Throwable mainException, AutoCloseable resource)
    {
        if (resource == null)
            return;
