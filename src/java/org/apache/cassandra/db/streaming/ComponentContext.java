...
public class ComponentContext implements AutoCloseable
{
    ...
    public static ComponentContext create(Descriptor descriptor)
    {
        ...
        return new ComponentContext(hardLinks, null, ComponentManifest.create(descriptor));
    }
    ...
    {
        if (dataRanges == null || component != Component.DATA)
        {
    ...
    {
        return sources.containsKey(component) ? sources.get(component) : new File(descriptor.filenameFor(component));
    }
